...
a identation que deste esta me a causar bugs tenta te manter fiel ao ficheiro mockexams.ts




Show thinking
Peço desculpa pelo problema. Tem toda a razão, a consistência da indentação é crucial.

Analisei novamente o ficheiro mockExams.ts original para garantir que a formatação seja idêntica.

Aqui está o código para o Mock Exam 1 com a indentação corrigida para corresponder exatamente à do seu projeto:

TypeScript

import { Exam } from '@/types/exam';

// O array completo `mockExams` seria declarado aqui.
// Este é o primeiro objeto dentro desse array.
const mockExam1: Exam = {
  ...
  questions: [
    ...
    },
    {
      ...
      correctAnswer: 3,
      explanation: 'Agile team members are expected to solve most of their technical problems
      }
    ]
  },
  {
