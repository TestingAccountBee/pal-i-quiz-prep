{
  ...
  "questions": [
    {
      "id": "q1_1",
      "question": "Who is responsible for sizing the Product Backlog Items?",
      "options": [
    ...
    {
      "id": "q1_2",
      "question": "What is the purpose of having a Sprint Goal for the Developers?",
      "options": [
    ...
    },
    {
      ...
      "explanation": "According to the Scrum Guide, if multiple Scrum Teams are working on the same product, they must have a shared Product Backlog. This ensures that all teams are aligned and working towards the same goal."
    },
    {
      "id": "q1_5",
      "question": "What is an important consideration when determining the length of a Sprint?",
      "options": [
    ...
    {
      "id": "q1_6",
      "question": "True or False: When several Scrum Teams are working on the same product, each team should have its own Product Backlog.",
      "options": [
        "TRUE",
        "FALSE"
      ],
    ...
    {
      "id": "q1_7",
      "question": "During a Sprint Retrospective, the Developers suggest holding the Daily Scrum only on Mondays and Wednesdays. What are the two most appropriate actions for the Scrum Master to take?",
      "options": [
      ...
      "explanation": "The Scrum Master plays a crucial role in facilitating effective communication and collaboration within the team. By guiding the team's understanding of the Daily Scrum's significance and actively engaging with them to improve its outcomes, the Scrum Master helps foster transparency, alignment, and continuous improvement in the Scrum process."
    },
    {
      "id": "q1_8",
      "question": "Several Developers on one of the eighth new Scrum Teams working on a single product ask the Scrum Master how to coordinate their efforts with the other teams. What should the Scrum Master do?",
      "options": [
      ...
      "explanation": "According to the Scrum Guide, it is the responsibility of the Developers to coordinate their work with other teams to create an Integrated Increment. The Scrum Master should teach the Developers about this responsibility and help them to collaborate effectively with the other teams."
    },
    {
      "id": "q1_9",
      "question": "What are suitable subjects for discussion during a Sprint Retrospective?",
      "options": [
    ...
    {
      "id": "q1_10",
      "question": "What are two responsibilities of the Scrum Master during a Sprint?",
      "options": [
    ...
    {
      "id": "q1_11",
      "question": "What is the primary purpose of the Scrum Master's presence at the Daily Scrum?",
      "options": [
      ...
      "explanation": "The Daily Scrum is primarily for the Developers to discuss their progress, plan their work for the day, and identify any potential obstacles. The Scrum Master's role is to ensure that the Daily Scrum is being held and that the Developers understand the purpose and benefits of the event. However, their attendance is not mandatory, as the Daily Scrum is primarily for the Developers to collaborate and self-manage."
    },
    {
      "id": "q1_12",
      "question": "What are three functions of the Definition of Done?",
      "options": [
      ...
      "explanation": "The Definition of Done serves several purposes. It guides the Developers on how many Product Backlog items to select for the Sprint, increases transparency, and creates a shared understanding of when work is complete. The Definition of Done helps the Scrum Team to ensure that the Increment is of high quality and meets the expectations of the stakeholders."
    },
    {
      "id": "q1_13",
      "question": "Which statement is true regarding the duration of a Sprint?",
      "options": [
    ...
    {
      "id": "q1_14",
      "question": "Which Scrum Value is compromised by working on Product Backlog items with low business value?",
      "options": [
        "Courage.",
        "Focus.",
        "Respect.",
    ...
    {
      "id": "q1_15",
      "question": "What are two methods of forming Scrum Teams that align with Scrum's values?",
      "options": [
      ...
      "explanation": "Scrum values self-management and empowerment of the team. Allowing the people to organize into Scrum Teams themselves or having existing teams propose how they would like to organize into the new structure are both consistent with Scrum's values."
    },
    {
      "id": "q1_16",
      "question": "What is the best description of the Sprint Review?",
      "options": [
      ...
      "explanation": "The Sprint Review is an event at the end of the Sprint where the Scrum Team and stakeholders inspect the outcome of the Sprint and determine what to do next. It is an opportunity for the Scrum Team to demonstrate the work done during the Sprint and to receive feedback from the stakeholders."
    },
    {
      "id": "q1_17",
      "question": "When does a Developer assume accountability for an item in the Sprint Backlog?",
      "options": [
      ...
      "explanation": "According to the Scrum Guide, all Developers on the Scrum Team share accountability for items in the Sprint Backlog. The Developers work together as a team to complete the work in the Sprint Backlog and to achieve the Sprint Goal."
    },
    {
      "id": "q1_18",
      "question": "Which of the following are timeboxed events in Scrum?",
      "options": [
        "Sprint Planning.",
        "Daily Scrum.",
    ...
    },
    {
      ...
      "explanation": "According to the Scrum Guide, the Product Owner is the only person with the authority to cancel a Sprint. This may occur if the Sprint Goal becomes obsolete or if external circumstances change, making it no longer makes sense to continue with the current Sprint. While other members of the Scrum Team and stakeholders may provide input and feedback, ultimately, it is up to the Product Owner to make this decision."
    },
    {
      "id": "q1_22",
      "question": "At what point does a Developer become responsible for the value of a Product Backlog item selected for the Sprint? ",
      "options": [
    ...
    },
    {
      ...
      "explanation": "The Product Backlog in Scrum is dynamic and can evolve as the project progresses. It is not a comprehensive list of all requirements but rather an ordered list of desired product features. The Product Owner is responsible for managing the Product Backlog, and changes do not require approval from a change control board. The Backlog is flexible and allows for adaptation based on customer feedback and market changes."
    },
    {
      "id": "q1_24",
      "question": "As self-managing professionals, which of the following do Developers manage? ",
      "options": [
        "The release plan.",
    ...
    {
      "id": "q1_25",
      "question": "Under what circumstances is the Product Owner required to attend the Daily Scrum? ",
      "options": [
    ...
    {
      "id": "q1_27",
      "question": "If the frequency of the Daily Scrum were reduced to every two or three days, what would be three key concerns? ",
      "options": [
    ...
    {
      "id": "q1_28",
      "question": "A Product Owner seeks advice from the Scrum Master on estimating the size of the work in Scrum. What guidance should the Scrum Master provide? ",
      "options": [
    ...
    {
      "id": "q1_29",
      "question": "When can a Product Backlog item be considered done? ",
      "options": [
    ...
    {
      "id": "q1_30",
      "question": "Is it true or false that every Scrum Team must have a Product Owner and Scrum Master? ",
      "options": [
    ...
    {
      "id": "q1_33",
      "question": "A new Product Owner joins a Scrum Team that has been working on a product for nine Sprints. She understands that she is responsible for the Product Backlog, but is unsure about her other responsibilities. Which of the following are part of the Product Owner's accountability on a Scrum Team? ",
      "options": [
    ...
    {
      "id": "q1_34",
      "question": "What are two key ways in which a Scrum Master helps a Scrum Team achieve its highest level of productivity? ",
      "options": [
    ...
    {
      "id": "q1_35",
      "question": "Which of the following best describes the primary responsibility of a Product Owner? ",
      "options": [
    ...
    {
      "id": "q1_36",
      "question": "True or False: The Scrum includes an accountability called \"Project Manager\"? ",
      "options": [
        "TRUE",
        "FALSE"
      ],
      ...
      "explanation": "According to the Scrum Guide, Scrum does not include an accountability called \"Project Manager.\" Scrum defines three accountabilities: the Product Owner, the Scrum Master, and the Developers. These accountabilities work together as a self-managing team to deliver a \"Done\" Increment at the end of each Sprint. While some organizations may choose to have a project manager work with a Scrum Team, this accountability is not defined within the Scrum framework."
    },
    {
      "id": "q1_37",
      "question": "Sara is the Product Owner of a Scrum Team responsible for a software product that aimed to revolutionize online shopping. Sarah had been working closely with the Scrum Team for several Sprints, and her expertise and market knowledge were highly valued. What are Sarah's primary responsibilities?",
      "options": [
    ...
    {
      "id": "q1_39",
      "question": "In Scrum, what are two ways that regulatory compliance issues can be addressed? ",
      "options": [
    ...
    },
    {
      ...
      "explanation": "According to the Scrum Guide, an Increment is a concrete stepping stone toward the Product Goal. Each Increment is additive to all prior Increments and thoroughly verified, ensuring that all Increments work together. In order to provide value, the Increment must be usable. Multiple Increments may be created within a Sprint. The sum of the Increments is presented at the Sprint Review, thus supporting empiricism. However, Scrum has no rules or recommendations regarding when to release an Increment. It can be released multiple times during a Sprint or not at all."
    },
    {
      "id": "q1_41",
      "question": "What is the most important characteristic of a Scrum Team?",
      "options": [
    ...
    {
      "id": "q1_42",
      "question": "When can new work be added to the Sprint Backlog?",
      "options": [
    ...
    {
      "id": "q1_44",
      "question": "When multiple Scrum Teams are working on one product, which of the following conditions should be met?",
      "options": [
    ...
    {
      "id": "q1_46",
      "question": "What is the purpose of having a timebox for an event in Scrum?",
      "options": [
    ...
    {
      "id": "q1_47",
      "question": "How long is the timebox for the Sprint Review for a one-month Sprint?",
      "options": [
        "1 day.",
        "4 hours.",
        "As long as needed.",
    ...
    {
      "id": "q1_48",
      "question": "How can the Scrum Team ensure that non-functional requirements are visible and transparent?",
      "options": [
    ...
    {
      "id": "q1_49",
      "question": "True or False: To start using Scrum, it is only required to have a Product Owner with a vision of what needs to be built and enough work for the first Sprint, a Scrum Master, and the Developers to turn the ideas into Increments.",
      "options": [
        "TRUE",
        "FALSE"
      ],
    ...
    },
    {
      ...
      "explanation": "According to the Scrum Guide, one of the appropriate services for a Scrum Master in regard to the Daily Scrum is to teach the Developers to keep the Daily Scrum within 15 minutes. The Daily Scrum is an event for the Developers to synchronize activities and create a plan for the next 24 hours. The Scrum Master ensures that the Developers have the meeting, but the Developers are responsible for formatting and conducting the Daily Scrum."
    },
    {
      "id": "q1_51",
      "question": "Which group primarily benefits from the inspect and adapt opportunity provided by the Sprint Review?",
      "options": [
    ...
    {
      "id": "q1_52",
      "question": "A Developer expresses concerns about data privacy issues to the Scrum Master. What is the most appropriate action for the Scrum Master to take?",
      "options": [
      ...
      "explanation": "The Scrum Master is responsible for promoting and supporting Scrum as defined in the Scrum Guide. They do this by helping everyone understand Scrum theory, practices, rules, and values. In this situation, the Scrum Master should encourage the Developer to share their concerns with the team as soon as possible so that the team can work together to address the issue."
    },
    {
      "id": "q1_53",
      "question": "What is the best technique for the Scrum Master to ensure effective communication between the Developers and the Product Owner?",
      "options": [
    ...
    {
      "id": "q1_55",
      "question": "Who is responsible for ensuring that everyone on the Scrum Team completes their tasks for the Sprint?",
      "options": [
        "The Project Manager.",
        "The Product Owner.",
        "The Scrum Master.",
    ...
    {
      "id": "q1_57",
      "question": "What methods can a Scrum Master use when there is a disagreement within the Scrum Team about which agile practices to implement?",
      "options": [
      ...
      "explanation": "The Scrum Master's role is to promote and support Scrum, as outlined in the Scrum Guide. They do this by helping everyone understand Scrum theory, practices, rules, and values. In cases of internal disagreements, the Scrum Master can involve the entire team in decision-making and utilize coaching techniques like open questions and active listening."
    },
    {
      "id": "q1_58",
      "question": "When using burndown charts to monitor progress, what aspect do they measure? ",
      "options": [
    ...
    {
      "id": "q1_59",
      "question": "During the Sprint, who is responsible for deciding how work is carried out? ",
      "options": [
        "The Developers",
        "The entire Scrum Team",
        "The Scrum Master.",
      ...
      "explanation": "According to the Scrum Guide, the Developers are responsible for organizing and managing their own work during the Sprint. They are self-managing, which means they have the autonomy to decide how to best accomplish their work, rather than being directed by others outside the team. "
    },
    {
      "id": "q1_60",
      "question": "What are the characteristics of the Daily Scrum?",
      "options": [
    ...
    {
      "id": "q1_61",
      "question": "What is the definition of a cross-functional Scrum Team?",
      "options": [
      ...
      "explanation": "A cross-functional Scrum Team is one where the team members collectively possess all the skills necessary to create value each Sprint. This means that the team is self-sufficient and does not rely on individuals outside the team to complete their work."
    },
    {
      "id": "q1_62",
      "question": "When should a Sprint Retrospective take place?",
      "options": [
      ...
      "explanation": "According to the Scrum Guide, the Sprint Retrospective concludes the Sprint."
    },
    {
      "id": "q1_63",
      "question": "What is the output of Sprint Planning that gives the Scrum Team a target and direction for the Sprint?",
      "options": [
    ...
    {
      "id": "q1_64",
      "question": "Ideally, how should a large group of people be organized into Scrum Teams according to Scrum theory?",
      "options": [
      ...
      "explanation": "According to Scrum theory, the best way to divide a large group of people into multiple Scrum Teams is for the people to divide themselves into teams based on their understanding of the product, the product vision, and the rules of the Scrum framework. This allows for self-management and empowers individuals to take ownership of their work."
    },
    {
      "id": "q1_65",
      "question": "How can the transparency of an Increment be improved?",
      "options": [
    ...
    {
      "id": "q1_66",
      "question": "How does Scrum encourage self-management within the Scrum Team?",
      "options": [
    ...
    {
      "id": "q1_67",
      "question": "True or False: The Product Owner and the Scrum Master cannot be a part of Developers",
      "options": [
        "TRUE",
        "FALSE"
      ],
      ...
      "explanation": "Scrum does not prohibit the Product Owner or the Scrum Master do development work. However, it is not the best practice because it could create a conflict of interest."
    },
    {
      "id": "q1_68",
    ...
    {
      "id": "q1_69",
      "question": "In which Scrum event do key stakeholders collaborate with the Scrum Team about the outcome of the Sprint and future adaptations?",
      "options": [
    ...
    {
      "id": "q1_70",
      "question": "Which of the following ways of forming Scrum Teams meet Scrum´s values?",
      "options": [
    ...
    {
      "id": "q1_72",
      "question": "The Scrum Team is cross-functional. What does this mean in practice?",
      "options": [
    ...
    {
      "id": "q1_74",
      "question": "Which accountability makes up a Scrum Team?",
      "options": [
        "End users.",
    ...
    {
      "id": "q1_75",
      "question": "What is likely to happen if an organization adopts Scrum but changes the terminology to fit with existing terminology?",
      "options": [
    ...
    {
      "id": "q1_77",
      "question": "What should happen if a Product Backlog item worked on during a Sprint does not meet the Definition of Done?",
      "options": [
    ...
    {
      "id": "q1_78",
      "question": "How much work must the Developers do to complete a Product Backlog item selected during Sprint Planning?",
      "options": [
    ...
    {
      "id": "q1_79",
      "question": "What should the Developers do if the CEO asks them to add an important item to a Sprint that is already underway?",
      "options": [
      ...
      "explanation": "If the CEO asks the Developers to add a \"very important\" item to a Sprint that is already in progress, the Developers should inform the Product Owner so they can work with the CEO. The Product Owner is responsible for managing the Product Backlog and deciding what items should be included in the Sprint. The Developers should not add the item to the current Sprint without consulting with the Product Owner."
    },
    {
      "id": "q1_80",
